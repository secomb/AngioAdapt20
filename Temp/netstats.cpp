...
{
	extern int nseg,nnod,nnt,nnv,num_runs_actual,nsplus,nsminus,nsspr,nspruned,imainmax,imain;
	...
	extern float totalexist_length, hypox_fract, time1, extraction;

	int totalexist_count,existflow_count,iseg,inod,inod1,inod2,inod_test,previnod_test,inod1_orig,i,irun,max = 200,itp,nodtypflow,ncount;
	int *nodtypdist;
	...
	fprintf(ofp,"%5i %7.2f %8.1f %8.1f  %10i  %10i  %10.1f %10.1f  %10i\n",
		num_runs_actual, time1, totalexist_length, existflowing_length, totalexist_count, existflow_count, totalexist_volume,
	...
	fprintf(ofp,"%5i %7.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %7i %7i %7i %7i %7i\n",
		num_runs_actual, time1, totalexist_length, Aflowing_length, Vflowing_length, Cflowing_length,
	...
	fprintf(ofp,"%5i %7.2f      ",num_runs_actual, time1);
	...
	fprintf(ofp,"%5i %7.2f %f %f %f %f %f\n",num_runs_actual, time1, demand,consumption,qinsum,extraction,hypox_fract);
	fclose(ofp);
