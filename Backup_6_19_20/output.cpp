...
//	picturenetwork(nodvar,ksseg,"ShrinkFac.ps");
//	picturenetwork(nodvar,diam,"Diam.ps");
//	picturenetwork(nodvar,q,"Flow.ps");
//	picturenetwork(nodvar,hd,"Hematocrit.ps");
//	picturenetwork(nodvar,metsig,"Metsig.ps");
//	picturenetwork(nodvar,condup,"Condup.ps");
//	picturenetwork(nodvar,conddown,"Conddown.ps");
//	picturenetwork(nodvar,stot,"Stot.ps");
}
